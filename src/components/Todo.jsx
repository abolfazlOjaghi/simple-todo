...
const Todo = ({ id, title, isDone, onDelete, onDone, priority }) => {
    ...
    return (
        <div className="lg:w-225 bg-white px-8 max-sm:px-3 py-2 rounded-lg sm:text-lg font-semibold flex justify-between items-center dark:bg-gray-800 shadow-2xl hover:shadow-lg dark:shadow-gray-800 duration-600 md:w-180 sm:w-155 max-sm:w-screen">
            <p>{title}</p>
